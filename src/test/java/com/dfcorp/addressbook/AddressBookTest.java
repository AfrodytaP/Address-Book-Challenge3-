...
public class AddressBookTest {
    ...
    // Requirement 10 - Tests generated by Copilot, Tests the searchContactsByPhoneNumber()
    @Nested
    class SearchContactsByPhoneNumber {
        @Test
        public void testSearchContactByPhoneNumberWithEmptyAddressBook() {
            AddressBook addressBook = new AddressBook();

            ArrayList<Contact> results = addressBook.searchContactsByPhoneNumber("1234567890");
            assertTrue(results.isEmpty());
        }

        @Test
        public void testSearchContactByPhoneNumberWithNonExistentNumber() {
            AddressBook addressBook = new AddressBook();
            Contact contact = new Contact("John", "Doe", "07345678906", "john.doe@example.com");
            addressBook.addContact(contact);

            ArrayList<Contact> results = addressBook.searchContactsByPhoneNumber("0987654321");
            assertTrue(results.isEmpty());
        }

        @Test
        public void testSearchContactByPhoneNumberWithNullNumber() {
            AddressBook addressBook = new AddressBook();
            Contact contact = new Contact("John", "Doe", "07345678907", "john.doe@example.com");
            addressBook.addContact(contact);

            assertThrows(IllegalArgumentException.class, () -> {
                addressBook.searchContactsByPhoneNumber(null);
            });
        }

        @Test
        public void testSearchContactByPhoneNumberWithEmptyNumber() {
            AddressBook addressBook = new AddressBook();
            Contact contact = new Contact("John", "Doe", "07634567890", "john.doe@example.com");
            addressBook.addContact(contact);

            assertThrows(IllegalArgumentException.class, () -> {
                addressBook.searchContactsByPhoneNumber("");
            });
        }
    }
